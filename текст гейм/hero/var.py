...
def hunt():
    ...
    if a == 1:
        print('Идет охота подождите 2 секунды')
        time.sleep(2)
...
def cheack():
    for i in stud.cur.execute(f'SELECT * FROM game WHERE login = "{stud.User_login}"'):
